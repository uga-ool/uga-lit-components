...
- **Franklin College of Arts and Sciences:** template code `franklin` with logo `/shared/ugaonline/templates/franklin/img/FRANKLIN_logo_Arch_CW.svg` and default link `franklin.uga.edu`.
